...
export default function ContactComp() {
  ...
  const container: Variants = {
    ...
    show: {
      ...
      transition: {
        ...
        delayChildren: prefersReduced ? 0 : 0.16,
      },
    },
  };
  ...
  const iconPulse: Variants = {
    initial: { scale: 1 },
    hover: { scale: 1.08, transition: { duration: 0.25, ease: EASE_SOFT } },
  };
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            ...
            <motion.div
              variants={popCard}
              whileHover={{ y: -2 }}
              className="group flex items-center gap-4 rounded-xl bg-white ring-1 ring-gray-100 shadow-sm p-4 hover:shadow-md transition-all duration-300"
            >
              <motion.div
                variants={iconPulse}
                initial="initial"
                whileHover="hover"
                className="shrink-0 grid place-content-center h-11 w-11 rounded-lg bg-[#eef2ff] text-[#0a1f44]"
              >
            ...
            <motion.div variants={fadeUp} className="pt-1">
              ...
              <motion.div className="mt-3 flex items-center gap-3" variants={container}>
                {[
                  { href: "https://www.facebook.com/3laa.ref3t/", label: "Facebook", Icon: Facebook },
                  { href: "https://www.linkedin.com/in/alaa-ref3t-x1/", label: "LinkedIn", Icon: Linkedin },
                  { href: "https://github.com/AlaaRef3t", label: "GitHub", Icon: Github },
                ].map(({ href, label, Icon }) => (
                  <motion.a
                    key={label}
                    variants={social}
                    ...
                    aria-label={label}
                    href={href}
                    className="group h-10 w-10 grid place-content-center rounded-lg ring-1 ring-gray-200 bg-white transition-colors"
                  >
                    <Icon className="h-5 w-5 text-[#5c6872] transition-all duration-300 group-hover:scale-110 group-hover:text-[#00897b]" />
                  </motion.a>
                ))}
              </motion.div>
            </motion.div>
            ...
            <motion.div
              variants={popCard}
              className="rounded-2xl bg-white ring-1 ring-gray-100 shadow-sm p-5 hover:shadow-md transition-all duration-300"
            >
              <p className="text-[#0a1f44] font-semibold">Currently Available</p>
              <p className="mt-2 text-sm text-[#5c6872] leading-relaxed">
                I am currently open to new opportunities and exciting projects. Whether it is a full-time position, freelance work, or collaboration, I am always interested in discussing innovative ideas.
              </p>
          ...
          >
            ...
            <motion.button
              ...
              initial="rest"
              whileTap="tap"
              className="cursor-pointer mt-6 inline-flex items-center justify-center gap-2 w-full sm:w-auto rounded-lg bg-[#00897b] hover:bg-[#00695c] text-white font-medium px-6 py-3 shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#00897b] transition-colors"
            >
