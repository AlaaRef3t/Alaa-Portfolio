      ...
      >
        {[
          ...
          item.divider ? (
            ...
            <motion.div key={item.label} variants={stripItem} className="text-center mx-2 sm:mx-4">
              <div className="text-xl sm:text-2xl md:text-3xl font-bold text-[#00897b]">{item.num}</div>
